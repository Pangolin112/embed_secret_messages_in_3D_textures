...
from visual_anagrams_sd.samplers import sample_sd, sample_sd_depth
...
def visual_anagrams_2d_sd_depth():
    ...
    # output directory
    output_path = './outputs/visual_anagrams_2d_depth'
    ...
    # prompts
    # prompt_1 = 'painting of a horse'
    # prompt_2 = 'painting of a snowy mountain village'
    ...
    # prompt_1 = 'a photo of a japanese style living room'
    # prompt_2 = 'a photo of ancient ruins'

    prompt_1 = 'a photo of a scientific style living room'
    prompt_2 = 'a photo of a castle'
    ...
    # # Make save path
    # save_video_path = output_path + '/animation_visual_anagrams_sd_depth.mp4'
