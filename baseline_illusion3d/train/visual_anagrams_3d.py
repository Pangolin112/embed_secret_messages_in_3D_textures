...
def visual_anagrams_3d():
    ...
    config_path = 'config/config_pytorch3d_uv.yaml'
    ...
    # obj_filename = os.path.join(DATA_DIR, "DeformingThings4D/deerOMG_Jump/deer_rotated.obj")
    # obj_filename = os.path.join(DATA_DIR, "objaverse/car/car_rotated.obj")

    output_path = './outputs/visual_anagrams_3d'
    ...
    uv_coords_list, uv_coords_eval_list, depth_tensor_list, angle_deviation_list = data_prepare(dtype_half, num_views_eval, num_views, device, dist, at, render_size, faces_per_pixel, new_mesh)
