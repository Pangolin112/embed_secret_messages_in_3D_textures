...
def scannetpp_large_scene_datasaver_chunk():
    """
    ...
    scene_list = ['0e75f3c4d9'] # '0cf2e9402d' '49a82360aa' 'fb5a96b1a2' e9ac2fc517, e3ecd49e2b, 0e75f3c4d9
    ...
    for scene_id in tqdm(scene_list):
        ...
        print(f"Processing scene {scene_id} with {len(train_frames)} frames...")
